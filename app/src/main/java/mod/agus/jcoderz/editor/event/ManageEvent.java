...
public class ManageEvent {
    ...
    public static void c(String eventName, ArrayList<String> list) {
        switch (eventName) {
            ...
            default -> EventsHandler.addEventsToListener(eventName, list);
        }
    }
    ...
    public static int d(String str) {
        return switch (str) {
            ...
            case "onSaveInstanceState", "onCreateOptionsMenu", "onCreateContextMenu", "onContextItemSelected", "onOptionsItemSelected" ->
                    R.drawable.bg_event_type_activity;
            case "onSuccessLink" -> R.drawable.event_fb_dynamic_success;
            case "onPatternLockCleared", "onPatternLockProgress", "onPatternLockStarted", "onPatternLockComplete" ->
                    R.drawable.event_pattern_lock_view;
            ...
            case "onScrollChanged", "onPageChanged", "onPageScrolled", "onRecyclerScrolled", "onRecyclerScrollChanged", "onNavigationItemSelected", "onScrolled", "onTabUnselected", "onPageSelected", "onTabSelected", "onTabReselected" ->
    ...
    public static String e(String eventName) {
        return switch (eventName) {
            ...
            case "onSaveInstanceState" ->
                    Helper.getResString(R.string.on_activity_save_instance_state);
            case "onCreateOptionsMenu" -> Helper.getResString(R.string.on_create_options_menu);
            case "onVerificationCompleted" -> "onVerificationCompleted";
            case "onRecyclerScrollChanged", "onScrollChanged" -> "onScrollStateChanged";
            case "onCreateContextMenu" -> Helper.getResString(R.string.on_create_context_menu);
            case "onRestoreInstanceState" ->
                    Helper.getResString(R.string.on_activity_restore_instance_state);
            case "onContextItemSelected" -> Helper.getResString(R.string.on_context_menu_selected);
            ...
            case "onOptionsItemSelected" -> Helper.getResString(R.string.on_options_menu_selected);
            ...
            case "onUpdateProfileComplete", "onEmailVerificationSent", "onDateChanged", "onDeleteUserComplete", "onNavigationItemSelected", "onDateSet", "onCompletion", "onPatternLockCleared", "onQueryTextChanged", "onUpdateEmailComplete", "onError", "onPageScrolled", "onVerificationFailed", "onGoogleSignIn", "onAccountPicker", "onTimeSet", "signInWithPhoneAuthComplete", "onRatingChanged", "onPatternLockProgress", "onTabSelected", "onTabReselected", "onLetterSelected", "onTabUnselected", "onPageSelected", "onPrepared", "onQueryTextSubmit", "onCodeSent", "onTimeChanged", "onUpdatePasswordComplete", "onAdDismissedFullScreenContent", "onAdFailedToShowFullScreenContent", "onAdShowedFullScreenContent", "onUserEarnedReward" ->
                    eventName;
    ...
    public static String f(String targetId, String eventName, String eventLogic) {
        ...
        final String setAdFullScreenContentCallback = targetId.isEmpty() ? "\r\n" : targetId + " = _param1;\r\n" +
                ...
                eventLogic + "\r\n";
        switch (eventName) {
            case "onUpdateProfileComplete", "onEmailVerificationSent", "onDeleteUserComplete", "onUpdateEmailComplete", "onUpdatePasswordComplete" -> {
                return "@Override\r\n" +
    ...
    public static String h(String eventName) {
        return switch (eventName) {
            case "onUpdateProfileComplete", "onEmailVerificationSent", "onDeleteUserComplete", "onUpdateEmailComplete", "onGoogleSignIn", "signInWithPhoneAuthComplete", "onUpdatePasswordComplete" ->
            ...
            case "onBannerAdFailedToLoad", "onRewardAdFailedToLoad", "onInterstitialAdFailedToLoad", "onAdFailedToShowFullScreenContent" ->
    ...
    public static String i(String targetId, String eventName) {
        return switch (eventName) {
            case "onUpdateProfileComplete", "onEmailVerificationSent", "onDeleteUserComplete", "onUpdateEmailComplete", "onGoogleSignIn", "onUpdatePasswordComplete", "signInWithPhoneAuthComplete" ->
            ...
            case "onPrepared", "onCompletion", "onPatternLockCleared", "onAccountPickerCancelled", "onPatternLockStarted" ->
                    "When " + targetId + " " + eventName;
            case "onSaveInstanceState", "onCreateOptionsMenu", "onCreateContextMenu", "onRestoreInstanceState", "onContextItemSelected" ->
                    "When " + eventName;
            ...
            case "FBAdsBanner_onAdClicked", "FBAdsBanner_onAdLoaded", "FBAdsBanner_onLoggingImpression", "FBAdsInterstitial_onAdClicked", "FBAdsInterstitial_onAdLoaded", "FBAdsInterstitial_onLoggingImpression", "FBAdsInterstitial_onInterstitialDismissed", "FBAdsInterstitial_onInterstitialDisplayed" ->
            ...
            case "onBannerAdFailedToLoad", "onInterstitialAdFailedToLoad", "onRewardAdFailedToLoad", "onAdFailedToShowFullScreenContent" ->
