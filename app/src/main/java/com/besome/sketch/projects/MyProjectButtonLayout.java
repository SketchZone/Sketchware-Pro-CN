...
public class MyProjectButtonLayout extends CollapsibleLayout<MyProjectButton> {
    ...
    protected List<MyProjectButton> initializeButtons(@NonNull Context context) {
        return List.of(
                ...
                MyProjectButton.create(context, 1, R.drawable.ic_backup, getContext().getString(R.string.myprojects_list_menu_title_back_up)),
                ...
                MyProjectButton.create(context, 4, R.drawable.settings_96, getContext().getString(R.string.myprojects_list_menu_title_config))
        );
    }
