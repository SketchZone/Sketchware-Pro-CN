...
public class Tools extends AppCompatActivity {
            ...
            if (files.length > 1 || isDirectory) {
                new AlertDialog.Builder(this)
                        ...
                        .setSingleChoiceItems(new String[]{getString(R.string.common_word_delete)}, -1, (actionDialog, which) -> {
                            new AlertDialog.Builder(this)
                                    .setTitle(R.string.common_word_delete+ (isDirectory ? getString(R.string.common_word_folder):getString(R.string.common_word_file)) + "?")
                                    .setMessage(R.string.are_you_sure_you_want_to_delete_this + (isDirectory ? getString(R.string.common_word_folder):getString(R.string.common_word_file)) + R.string.permanently_this_cannot_be_undone)
                        ...
                        .setSingleChoiceItems(new String[]{getString(R.string.common_word_edit),getString(R.string.common_word_delete)}, -1, (actionDialog, which) -> {
                            switch (which) {
                                ...
                                case 1 -> new AlertDialog.Builder(this)
                                        ...
                                        .setMessage(R.string.are_you_sure_you_want_to_delete_this_file_permanently)
    ...
    private void signApkFileDialog() {
        ...
        apkPathDialog.b(getString(R.string.common_word_continue), v -> {
            if (!isAPKSelected[0]) {
                SketchwareUtil.toast(Helper.getResString(R.string.please_select_an_apk_file_to_sign), Toast.LENGTH_SHORT);
